...
class UserServiceImplTest {
    ...
    void getById_whenUserNotFound_thenObjectNotFoundThrown() {
        ...
        ObjectNotFoundException ex = assertThrows(ObjectNotFoundException.class, () -> userService.getById(0L));
    ...
    void update_whenUserForUpdate_thenObjectNotFoundThrown() {
        ...
        ObjectNotFoundException ex = assertThrows(ObjectNotFoundException.class, () -> userService.update(0L, new UserDto()));
        assertEquals("User not found", ex.getMessage());
    }
